...
4. The filter window uses [regex](https://www.regular-expressions.info) to filter the table. Note: you cannot specify the column to which the search criteria is applied. Examples:
      i. bench|rose|Larkin returns rows that correspond to those players -- so will ben|bar|ros (along with Ernie Lombardi)
      ...
      iii. ^e returns players name that begin with the letter "e" such as Eric Davis
