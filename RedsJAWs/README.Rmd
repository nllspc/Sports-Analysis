...
* Explanation about the decision-making and details involved in the calculations is [here](https://github.com/nllspc/Sports-Analysis/blob/master/RedsJAWs/Notes.md).
